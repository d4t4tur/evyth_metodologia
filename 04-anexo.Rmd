...
1.  Viajes a segundas viviendas: incluye los viajes de corta y larga duracion a segundas viviendas (tipos de viaje 3 y 4, respectivamente).
...
## Metodología de estimación del gasto por pernicte en el relevamiento de expectativas de viaje en fechas especiales
...
## Descripción del sistema informático utilizado para el relevamiento
...
## Manual del encuestador y guía de ejercicios a utilizar durante el relevamiento
...
::: {.note}
El __entorno habitual__ consiste en una zona cercana al lugar de residencia del hogar más todos los lugares visitados con asiduidad.
:::
...
##### Períodos de referencia de la EVyTH
...
#### Módulo 2: Inicio y operaciones básicas del sistema de ingreso de datos
...
##### Completamiento de la carátula: resúmen del llamado
...
##### Finalización del bloque 2 "segundas viviendas"
...
##### Realización de viajes de cada tipo en el período de referencia
...
##### Ubicación del destino provincial del viaje
...
##### Coincidencia del viaje o visita con fechas claves del período de referencia
...
##### Organización, consultas de información, actividades y evaluación del viaje o la visita de un día
...
##### Preguntas incluídas en el módulo
...
### Guía de ejercicios y cuadernillos de soluciones
...
##### Ejercicio 10. Período de referencia y mes de regreso del viaje
...
##### Ejercicio 11. Tipo y forma de registro de viajes
...
##### Ejercicio 12. Visitas de un día (bloque 9)
...
##### Ejercicio 13. Destino principal del viaje
...
##### Ejercicio 14. Tipo de alojamiento princial
...
##### Ejercicio 15. Medio de transporte principal utilizado
...
##### Ejercicio 16. Motivo principal del viaje
...
##### Ejercicio 17. Paquetes turísticos
...
##### Ejericio 2. Determinación de los miembros del hogar
...
```{r 149, echo=FALSE, fig.cap="" }
knitr::include_graphics('imagenes/figura6-149.png')
```
...
```{r 150, echo=FALSE, fig.cap="" }
knitr::include_graphics('imagenes/figura6-150.png')
```
...
##### Ejercicio 12. Visita de un día (bloque 9)
...
##### Ejercicio 14. Tipo de alojamiento principal.
...
##### Ejercicoi 16. Motivo principal del viaje
