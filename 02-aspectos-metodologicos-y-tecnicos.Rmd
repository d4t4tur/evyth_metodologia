...
El universo bajo estudio de la encuesta son los grandes aglomerados urbanos definidos en la EPH del INDEC. Por lo tanto, se consideran 32 aglomerados (para mayor detalle ver el cuadro en el Anexo). Los aglomerados se agrupan en las siguientes Regiones: [^aspectos-metodologicos-y-tecnicos-1]
...
**Cuadro 2: Periodicidad, Ventana de Observación y Períodos de Referencia**
...
Con el objetivo de mejorar la comparación interanual de las principales variables relevadas, se renueva periódicamente el conjunto de hogares encuestados (panel de respondentes) [^aspectos-metodologicos-y-tecnicos-3]. Conceptualmente, el esquema de rotación de una encuesta tiene incidencia sobre los siguientes aspectos:
...
[^aspectos-metodologicos-y-tecnicos-3]: La forma en que se produce esta renovación se denomina esquema de rotación. 
...
Para el presente trabajo se utiliza y adapta la macro CALMAR [^aspectos-metodologicos-y-tecnicos-6], escrita en lenguaje SAS por Sautory (1991), la cual calcula los pesos calibrados cuando la información auxiliar de una encuesta consiste de totales marginales conocidos dispuestos en una tabla de frecuencias de dimensiones arbitrarias. La macro mencionada trabaja con cuatro funciones, de las cuales para la EVyTH se trabaja sólo con tres. A continuación, se brinda una pequeña descripción de cada una de ellas.
...
[^aspectos-metodologicos-y-tecnicos-6]: El algoritmo del Calmar a utilizar durante la calibración puede ser consultado en: http://www.restore.ac.uk/PEAS/saspackage.php
...
**Cuadro 3: Coeficientes de Variación calculados según cada Informe de la EVyTH**
...
**Cuadro 4: Análisis de margen de error para informes de adelanto y final. Resultados básicos para agosto 2013**


**Gráfico 2: Análisis de margen de error para informes de adelanto y final. Visitantes (intervalo de confianza al 90%). Resultados para agosto 2013.**